                ...
                <form method="post" action="">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control <?= ($validation->hasError('stok') ? 'is-invalid' : '') ?>" id="stok" name="stok" required autofocus value="<?= old('stok') ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control <?= ($validation->hasError('harga') ? 'is-invalid' : '') ?>" id="harga" name="harga" required autofocus value="<?= old('harga') ?>">
                        <div class="invalid-feedback">
        ...
        $('.edit').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#category').val(data.id_cat_produk);
