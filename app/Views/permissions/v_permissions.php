...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3" style="background-color: #5a5c69;">
            <h6 class="m-0 font-weight-bold text-white d-inline">Daftar Permission</h6>
            <a href="#" class="btn btn-primary btn-icon-split float-right add" data-toggle="modal" data-target="#addPermissions">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php foreach ($permissions_data as $p) : ?>
                            <tr>
                                <td><?= $p->name ?></td>
                                <td><?= $p->description ?></td>
                                <td>
            ...
            <div class="modal-body">
                <form action="/permissions/add" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" class="form-control <?php if ($validation->hasError('name')) : ?>is-invalid<?php endif ?>" name="name" placeholder="Permissions Name" value="<?= old('name') ?>">
                    ...
                    <input type="hidden" name="id_permissions" id="permissionsid">
            </div>
