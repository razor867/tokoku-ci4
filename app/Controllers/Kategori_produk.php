...
class Kategori_produk extends BaseController
{
    ...
    public function listdata()
    {
        ...
        foreach ($list as $lt) {
            if (in_groups('Super Admin') || in_groups('Admin') || in_groups('Admin Produk') || in_groups('Admin Gudang')) {
                $button_action = '<a href="#" class="btn btn-warning btn-circle btn-sm edit" onclick="edit(\'' . $lt->id . '\')" data-toggle="modal" data-target="#kategori_produk_modal" title="Edit">
                                <i class="fas fa-exclamation-triangle"></i>
                              </a>
                              <a href="#" class="btn btn-danger btn-circle btn-sm delete" onclick="deleteData(\'_cat_product\',\'' . $lt->id . '\')" title="Delete">
