...
class Penjualan extends BaseController
{
    ...
    {
        if (in_groups('Super Admin') || in_groups('Admin') || in_groups('Admin Kasir')) {
            $column_order = array('nama_produk', 'nama_satuan', 'qty', 'total_jual', 'tanggal_jual', 'id');
        } else {
            $column_order = array('nama_produk', 'nama_satuan', 'qty', 'total_jual', 'tanggal_jual');
        }
        ...
        foreach ($list as $lt) {
            if (in_groups('Super Admin') || in_groups('Admin') || in_groups('Admin Kasir')) {
                $button_action = '<a href="#" class="btn btn-warning btn-circle btn-sm edit" onclick="edit(\'' . $lt->id . '\')" data-toggle="modal" data-target="#penjualan_modal" title="Edit">
                                <i class="fas fa-exclamation-triangle"></i>
                              </a>
                              <a href="#" class="btn btn-danger btn-circle btn-sm delete" onclick="deleteData(\'_datpen\',\'' . $lt->id . '\')" title="Delete">
